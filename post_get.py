...
class Mechanism:
    ...
    def send_get_request(self):
        ...
        try:
            ...
            print(self.mechanism_id, http, self.password, self.value, self.value2, self.value3, self.count, self.latitude, self.longitude)
...
if __name__ == "__main__":
    Pt1=     USM(mechanism_id=32046, value=0, value2=0, value3=0, count=0, latitude=42.8089, longitude=132.8865)
    Pt2=     USM(mechanism_id=32047, value=0, value2=0, value3=0, count=0, latitude=42.8082, longitude=132.8869)
    E3 =     USM(mechanism_id=32711, value=0, value2=0, value3=0, count=0, latitude=42.8094, longitude=132.8878)
    E4 =     USM(mechanism_id=32740, value=0, value2=0, value3=0, count=0, latitude=42.8106, longitude=132.8885)
    S5 =     USM(mechanism_id=32770, value=0, value2=0, value3=0, count=0, latitude=42.8118, longitude=132.8893)
    S6 =     USM(mechanism_id=32771, value=0, value2=0, value3=0, count=0, latitude=42.8122, longitude=132.8887)
    S7 =     USM(mechanism_id=32772, value=0, value2=0, value3=0, count=0, latitude=42.8144, longitude=132.8899)
    S8 =     USM(mechanism_id=32773, value=0, value2=0, value3=0, count=0, latitude=42.8171, longitude=132.8926)
    U9 =     USM(mechanism_id=32941, value=0, value2=0, value3=0, count=0, latitude=42.8132, longitude=132.8899)
    U10 =    USM(mechanism_id=32942, value=0, value2=0, value3=0, count=0, latitude=42.8144, longitude=132.8913)
    ...
    [x.chenge_value(0) for x in usms[::1]]
    [x.chenge_value(0.8) for x in usms[1::1]]
