...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Vue({
        ...
        data: {
            ...
            text: 'test',
            color: '#ff4466',
            ico: 'http://maps.google.com/mapfiles/kml/pal3/icon0.png',
            http: ['http://127.0.0.1:5000/api/v1.0/all_last_data_ico', 'http://35.241.126.216/api/v1.0/all_last_data'],
            markers: [
                { position: { lat: 42.8150, lng: 132.8907 }, title: 'Screen5', icon: 'http://maps.google.com/mapfiles/kml/pal3/icon12.png' },
                { position: { lat: 42.8145, lng: 132.8900 }, title: 'Screen6', icon: 'http://maps.google.com/mapfiles/kml/pal3/icon13.png' },
                { position: { lat: 42.8107, lng: 132.8880 }, title: 'Screen7', icon: 'http://maps.google.com/mapfiles/kml/pal3/icon14.png' }
            ],
