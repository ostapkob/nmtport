...
from app.functions import data_from_1c_by_id, add_fio
from app.functions import all_mechanisms_id, today_shift_date, data_from_1c
...
headers = ['INV_NUM', 'GREIFER_NUM',
           'GREIFER_VOL', 'FIO', 'DATA_NACH', 'DATA_KON']
