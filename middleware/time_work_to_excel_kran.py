...
def save_to_xlsx(avg_by_terminals):
    ...
    titles = ["date", "shift", "terminal", "number", "time", 'degrees90',
              'degrees180', 'fio', 'contract', 'start', 'finish', 'grab']
...
if __name__ == "__main__":
    date_start = datetime(2022, 11, 1).date()
    date_finish = datetime(2022, 11, 17).date()
