...
if __name__ == "__main__":
    S1 = Sennebogen(number=1, x=5001, y=1110, count=0, latitude=42.8089, longitude=132.8865)
    S2 = Sennebogen(number=2, x=5002, y=1110, count=0, latitude=42.8098, longitude=132.8865)
    ...
    S5 = Sennebogen(number=5, x=5005, y=1110, count=0, latitude=42.8089, longitude=132.8855)
    S6 = Sennebogen(number=6, x=5006, y=1110, count=0, latitude=42.8078, longitude=132.8865)
    S7 = Sennebogen(number=7, x=5007, y=1110, count=0, latitude=42.8089, longitude=132.8855)
    S8 = Sennebogen(number=8, x=5008, y=1110, count=0, latitude=42.8096, longitude=132.8859)
